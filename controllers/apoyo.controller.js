    ...
    Apoyo.destroy({
        where: { id: id }
            ...
            if(num == 1){
                ...
                res.send({
                    message: `No se encontro la solicitud de apoyo con id = ${id}!`
                });
            }
        })
        .catch(err => {
